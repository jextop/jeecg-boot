...
public class HttpUtils {
    public static HttpResponse doPost(
            String host, String path, Map<String, String> headers, Map<String, String> queryParams, String body
    ) throws IOException {
        HttpPost request = new HttpPost(buildUrl(host, path, queryParams));
    ...
    private static void setHeaders(HttpRequestBase httpRequest, Map<String, String> headers) {
        if (httpRequest == null || MapUtils.isEmpty(headers)) {
            return;
        }
